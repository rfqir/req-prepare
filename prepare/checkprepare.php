                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr class="parentRow">
                                                    ...
                                                    ?><?= $data['nama_user']; ?>
                                                        <input type="hidden" class="form-control ms-2" style="max-width: 200px;" name="iduser[]" value="<?= $iduser[$k]; ?>" required></td>
                                                </tr>
                                        <?php
                                            }
                                        }
            ...
            <div class="card bg-gray-100">
                <div class="card-body">
                    <form method="post">
                        ...
                        for ($i = 0; $i < $jum; $i++) {
                            $select = mysqli_query($conn, "SELECT image,nama,sku_toko FROM toko_id,product_toko_id WHERE toko_id.id_product = product_toko_id.id_product AND sku_toko = '$sku[$i]'");
                            while ($list = mysqli_fetch_array($select)) {
                                $gambar = $list['image'];
                                if ($gambar == null) {
                                    // jika tidak ada gambar
                                ...
                                <div class="card">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="d-flex justify-space-between text-sm" style="margin-left: 20px;">
                                            <strong>SKU:</strong> <input type="text" value="<?= $list['sku_toko']; ?>" class="form-control ms-2" style="max-width: 200px;" name="skut[]" readonly>
                                            <input type="hidden" value="<?= $iduser[$i]; ?>" class="form-control ms-2" style="max-width: 200px;" name="iduser[]" readonly>
                                            <input readonly type="hidden" name="requester" value="<?= $_SESSION['nama_user']; ?>" class="form-control">
                                        </div>
                                        <div class="d-flex justify-space-between text-sm" style="margin-left: 20px;">
                                            <strong>Quantity:</strong> <input type="text" placeholder="masukan QTY!" class="form-control ms-2" style="max-width: 200px;" name="quantity[]" required>
                                        </div>
                                    </div>
                                </div>
                        <?php
                        ...
                        ?>
                        <div class="mt-3 text-end">
                            <button type="submit" class="btn btn-primary" name="ds">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
